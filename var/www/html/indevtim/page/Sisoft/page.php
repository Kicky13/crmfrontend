...
require_once('page/Sisoft/define_spart.php');
						...
						<ul class="nav" id="side-menu">
							...
							<li><a href="#"><i class="fa fa-tasks fa-fw"></i> Work Order<span class="fa arrow"></span></a>
								<ul class="nav nav-second-level">
									...
									<li><a href="<?php echo PATH_EXPWO; ?>">Export WO to Excel</a></li>
									<li><a href="<?php echo PATH_EXMAN; ?>">Export Man Power to Excel</a></li>
								</ul>
							</li>
							<?php if ($_SESSION['groupID'] == "GROUP181120033150") { ?>
							...
							<?php } else if ($_SESSION['groupID'] == "GROUP200927074425") { ?>
								<li><a href="#"><i class="fa fa-wrench fa-fw"></i> Preventive<span class="fa arrow"></span></a>
									<ul class="nav nav-second-level">
										<li><a href="<?php echo PATH_PMLIST; ?>">PM List</a></li>
									</ul>
							...
							<?php if (_FULL_) { ?>
								...
								<li>
									<a href="#"><i class="fa fa-shopping-cart  fa-fw"></i> Journal Movement<span class="fa arrow"></span></a>
									<ul class="nav nav-second-level">
										<li><a href="<?php echo PATH_JVMOVEMENT; ?>">List JM</a></li>
										<li><a href="<?php echo PATH_EXJVMOVEMENT; ?>">Export JM to Excel</a></li>
									</ul>
								</li>
							<?php } ?>
						</ul>
