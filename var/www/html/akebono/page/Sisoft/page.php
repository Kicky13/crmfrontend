	...
	<?php if (!isset($_REQUEST['blankpage'])) { ?>
		<div id="wrapper">
			...
			<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 2px; z-index:2;">
				...
				$list = '';
				$q_area = 'SELECT DepartmentID, DepartmentNo, DepartmentDesc From department ORDER BY DepartmentDesc';
				...
				while ($qef_area = mysql_exe_fetch_array(array($qe_area, 1))) {
					...
					$list .= '<li><a class="list_asset ' . $qef_area[1] . '" href="' . PATH_ASSETS . '&area=' . $qef_area[0] . '">' . $qef_area[2] . '</a></li>';
				}
				$list .= '</ul>';
				?>
				<!------------------------------------------------------------------------------>
				...
				<div class="navbar-default sidebar" role="navigation" style="margin-top:56px">
					<div class="sidebar-nav navbar-collapse">
						<ul class="nav" id="side-menu">
							...
							<!--Jika Admin Link WO ANDON/MENU keluar-->
							<?php if ($_SESSION['userID'] == '') {
							?>
								<li><a href="<?php echo PATH_WOANDON; ?>"><i class="fa fa-dashboard fa-fw"></i> WO Andon</a></li>
							<?php
							} else {
							} ?>
							...
							<?php if (_VIEW_ && _DELETE_ && _EDIT_ && _INSERT_) { ?>
								<li>
									...
									<ul class="nav nav-second-level">
										...
										<li><a href="<?php echo PATH_PROBLEM; ?>">Problem</a></li>
										<li><a href="<?php echo PATH_SOLUTION; ?>">Solution</a></li>
										...
										<li><a href="#"><i class="fa fa-location-arrow fa-fw"></i> Location<span class="fa arrow"></span></a>
											<ul class="nav nav-third-level">
												...
												<li><a href="<?php echo PATH_LINE; ?>">Line</a></li>
		...
		<?php } else if (isset($_REQUEST['home_andon'])) { ?>
			<div id="page-wrapper">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">WO Andon</h1>
					</div>
					<!-- /.col-lg-12 -->
					<?php echo get_page(); ?>
				</div>
