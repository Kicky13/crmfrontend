  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { title: 'Dashboard Alpha', resource: 'Dashboard', action: 'read' },
          component: () => import('@/views/dashboard/alpha'),
        },
        {
          path: '/dashboard/beta',
          meta: { title: 'Dashboard Beta', resource: 'Dashboard', action: 'read' },
          component: () => import('@/views/dashboard/beta'),
        },
        {
          path: '/dashboard/gamma',
          meta: { title: 'Dashboard Gamma', resource: 'Dashboard', action: 'read' },
          component: () => import('@/views/dashboard/gamma'),
        },
        {
          path: '/dashboard/crypto',
          meta: { title: 'Crypto Terminal', resource: 'Dashboard', action: 'read' },
...
router.beforeEach((to, from, next) => {
  ...
  console.log(store.state.user.ability[0])
