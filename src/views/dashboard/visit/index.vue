<template>
  <div class="analytcs">
    <div class="analytcs_filter mb-4">
      <div class="row">
        <div class="col-md-2">
          <a-select
    ...
    <template v-if="visitDashboard.isLoading">
                    ...
                    <div class="customer-visit">
                      <div class="d-flex">
                        <div class="align-self-center">
                          ...
                          <br />
                          <span>{{
                            visitDashboard.listVisitInformation.realisasi_visit ?? 0
                          }}</span>
                        </div>
                        <div class="icon_image ml-auto">
                  ...
                  <div class="box mt-2">
                    ...
                    <div class="table-responsive text-nowrap">
                      <a-table
                        ...
                        :data-source="
                          visitDashboard.listCustomerTotal.data_customer_belum_dikunjungi
                        "
                        :loading="visitDashboard.isLoading"
                        :pagination="visitDashboard.paginationTokoBelumMapping"
                        :row-key="data => data"
...
export default {
  ...
  methods: {
    ...
    resetChart() {
      ...
      this.visitDashboard.listCustomerTotal = {}
      this.visitDashboard.listCustomerChart = {}
      this.visitDashboard.listVisitInformation = {}
    },
    ...
    async handleClick() {
      ...
      if (
        ...
        if (this.visitDashboard.status === `sukses`) {
          ...
          // Section Visit
          this.visitDashboard.dataTarget.forEach((value, key) => {
            this.dataBarVisited.series[0].data.push(value.jumlah)
            this.dataBarVisited.chartOptions.xaxis.categories.push(value.tanggal_rencana_kunjungan)
          })
