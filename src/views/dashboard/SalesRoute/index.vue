        ...
        <div class="row">
          <div class="col-xs-3 col-md-3">
            <a-form-item>
              ...
              <a-select class="col-lg-12 col-md-12 pr-2" style="width: 100% !important" placeholder="Distrik" v-model:value="salesRoute.formData.selectedDistrik" show-search @change="handleDistributor">
                  <a-select-option v-for="(distrik, index)  in salesRoute.dataDistrik" :key="index" :value="distrik.id_distrik">
          ...
          <div class="col-xs-3 col-md-3">
            <a-form-item>
              <a-select class="col-lg-12 col-md-12 pr-2" style="width: 100% !important" placeholder="Distributor" v-model:value="salesRoute.formData.selectedDistributor" show-search @change="handleSales">
                  <a-select-option v-for="(distributor, index)  in salesRoute.dataDistributor" :key="index"
          ...
          <div class="col-xs-3 col-md-3">
            <a-form-item>
              ...
              <a-select class="col-lg-12 col-md-12 pr-2" style="width: 100% !important" placeholder="Sales">
          ...
          <div class="col-xs-3 col-md-3">
            <a-form-item>
              <a-select class="col-lg-12 col-md-12 pr-2" style="width: 100% !important" placeholder="Tanggal">
                <a-select-option value="">Pilih Salah Satu</a-select-option>
              </a-select>
            </a-form-item>
          </div>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="col-md-12 col-sm-12">
          <fieldset class="border shadow px-3 pb-3" style="height:400px;">
      ...
      <div class="col-md-6 mt-3">
        <div class="row">
          <div class="col-md-12 col-sm-12">
            <fieldset class="border shadow px-3 pb-3 pt-3">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="bg-white p-3">
                    ...
                    <img src="@/assets/images/maps2.jpg" alt="Los Angeles" width="100%" height="150px">
                  </div>
                </div>
              </div>
            </fieldset>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12">
                <div class="table-responsive text-nowrap">
                  ...
                  <a-table :columns="salesRoute.columns" :loading="salesRoute.isLoading" :pagination="salesRoute.pagination">
                  </a-table>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12">
                <div class="table-responsive text-nowrap">
                  <!-- <a-table :columns="columns" :data-source="dataList" :row-key="dataSourceTable => dataSourceTable.id"
                    :pagination="pagination" :loading="isLoading"> -->
                  <a-table :columns="salesRoute.columns2" :loading="salesRoute.isLoading2" :pagination="salesRoute.pagination2">
