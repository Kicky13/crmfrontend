          ...
          <a-row>
            <a-col md="3" class="mr-4">
              <a-form-item label="Region">
                <a-select
                  ...
                  @change="setSelectMethodRegion"
                  placeholder=" -- Choose Region -- "
                  style="width: 200px"
                >
                  <a-select-option value="">ALL</a-select-option>
                  <a-select-option
                    v-for="(region, index) in listRegion"
                    :value="region.id"
                    :key="index"
                  >
                    {{ region.regionName }}
            ...
            <a-col md="3" class="mr-4">
              <a-form-item label="Provinsi">
                <a-select
                  v-model:value="formState.provinsiId"
                  @change="setSelectMethodProvinsi"
                  placeholder=" -- Choose Provinsi -- "
                  style="width: 200px"
                >
                  <a-select-option value="">ALL</a-select-option>
                  <a-select-option
                    v-for="(provinsi, index) in listProvinsi"
                    :value="provinsi.id"
                    :key="index"
                  >
            ...
            <a-col md="3" class="mr-4">
              <a-form-item label="Distributor">
                <a-select
                  v-model:value="formState.distributorId"
                  placeholder=" -- Chose Distributor -- "
                  style="width: 200px"
                >
                  <a-select-option value="">ALL</a-select-option>
                  <a-select-option
                    v-for="(distributor, index) in listDistributor"
